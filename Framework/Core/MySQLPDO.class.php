...
class MySQLPDO
{
    ...
    {
        $this->host = isset($param['host']) ? $param['host']
            : ucfirst($GLOBALS['configs']['database']['host']);
        $this->user = isset($param['user']) ? $param['user']
            : ($GLOBALS['configs']['database']['user']);
        $this->pwd = isset($param['pwd']) ? $param['pwd']
            :$GLOBALS['configs']['database']['pwd'];
        $this->port = isset($param['port']) ? $param['port']
            : ucfirst($GLOBALS['configs']['database']['port']);
        $this->charset = isset($param['charset']) ? $param['charset']
            : ucfirst($GLOBALS['configs']['database']['charset']);
        $this->dbname = isset($param['dbname']) ? $param['dbname']
            :ucfirst($GLOBALS['configs']['database']['dbname']);
    }
    ...
    private function initPDO()
    {
        try {
            $dsn = 'mysql:host='.$this->host.';dbname='
                .$this->dbname.';charset='.$this->charset.';port='.$this->port;

$(function(){
	...
	$(".uname").blur(function(){
        ...
        {
        	$(".uname").parent().addClass("checkedN");
        }
	});
	...
	$(".password,.password1").blur(function(){
        ...
        else if(Pval.length>16 || Pval.length<4)
        {   
        	$(".password").parent().addClass("errorC");
            $(".error3").html("密码应为4-16个字符，区分大小写");
            $(".error3").css("display","block");
        }
	...
	$(".uname").focus(function(){
		$(".uname").parent().removeClass("errorC");
		$(".uname").parent().removeClass("checkedN");
		$(".error1").hide();
		$("#mz_Float").css("top","232px");
		$("#mz_Float").find(".bRadius2").html("输入用户名");
	});
	//验证码栏获得焦点
